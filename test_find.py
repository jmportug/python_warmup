...
class TestFind(unittest.TestCase):
    ...
    def setUp(self):
        self.ctree = tree()
        self.ctree.generate(self.ctree.root,5)
    ...
    def test_FindExact(self):
        ...
        self.assertEqual(temp, "/1/2/3/4/5/8")
    ...
    def test_FindDirSingle(self):
        temp = find_dir("1?1", self.ctree.root)
...
#	ipdb.set_trace()
    ...
    def test_FindDirSpecified(self):
        ...
        self.assertEqual(temp, ['0', '1', '2', '3', '4'])
